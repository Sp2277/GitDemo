...
public class Admin_BaseClass extends Admin_SuiteBase
{
	...
	public void checkSuiteToRun() throws Exception{
		...
		System.out.println("Init in Vigilante Admin base");
		//To set TestSuiteList.xls file's path In FilePath Variable.
		ExcelPath = TestSuiteListExcel;
		SheetName = "SuitesList";
		SuiteName = "Vigilante_Admin";
		ToRunColumnName = "SuiteToRun";
		//Bellow given syntax will Insert log In applog.log file.
		Add_Log.info("Execution started for Vigilante Admin .");
